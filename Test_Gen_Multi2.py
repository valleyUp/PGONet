...
plt.colorbar()
plt.savefig('./case/MultiObs2/speed.png')
plt.show()
...
np.save('./case/MultiObs2/x1.npy', x1)
np.save('./case/MultiObs2/y1.npy', y1)
...
#保存文件
torch.save(c,'./case/MultiObs2/ref_speed.pt')
print(output_s.shape)
torch.save(output_s[:],'./case/MultiObs2/o_temp.pt')
