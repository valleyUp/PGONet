...
# 	print(data.shape)
# 确保目录存在
output = torch.load("./tensor_34095_0_T3.pt")
...
# #保存文件
# torch.save(c,'./case/Forward2/ref_speed.pt')
# print(output_s.shape)
# torch.save(output_s[:],'./case/Forward2/o_temp.pt')
torch.save(output_s[:],'./Forward2.pt')
